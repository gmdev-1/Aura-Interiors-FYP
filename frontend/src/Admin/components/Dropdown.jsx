    ...
    >
      ...
      >
        <div className="w-8 h-8 bg-purple-600 rounded-full mr-1 flex items-center justify-center">
            <RiUserSettingsLine className="text-white" size={18} />
        </div>
        {userData.name}
        <span
      ...
      <ul
        className={`dropdown-menu absolute right-0 mt-8 w-40 bg-white border rounded-md shadow-lg z-10 transition-opacity duration-200 ${
