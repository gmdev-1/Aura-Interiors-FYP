...
from Admin.views import CategoryCreateView, CategoriesListView, CategoryRetrieveView, CategoryDeleteView, CategoryUpdateView, ProductCreateView, ProductsListView, ProductRetrieveView, ProductDeleteView, ProductUpdateView
